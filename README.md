...
This service is part of the **cerami-craft** project, responsible for product-related APIs.
...
2.  **Build and run services:**
    ...
    *The Swagger will be available at `http://localhost/product-ms/v1/swagger/index.html`.*